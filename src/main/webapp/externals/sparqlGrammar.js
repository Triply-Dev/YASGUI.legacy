...
var ll1_table=
{
  ...
  "*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])" : {
     "+": ["or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "-": ["or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "INTEGER_POSITIVE": ["or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DECIMAL_POSITIVE": ["or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DOUBLE_POSITIVE": ["or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "INTEGER_NEGATIVE": ["or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DECIMAL_NEGATIVE": ["or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DOUBLE_NEGATIVE": ["or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "AS": [], 
     ")": [], 
     ",": [], 
     "||": [], 
  ...
  "additiveExpression" : {
     "!": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "+": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "-": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "VAR1": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "VAR2": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "(": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STR": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "LANG": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "LANGMATCHES": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DATATYPE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "BOUND": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "IRI": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "URI": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "BNODE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "RAND": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "ABS": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "CEIL": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "FLOOR": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "ROUND": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "CONCAT": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRLEN": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "UCASE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "LCASE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "ENCODE_FOR_URI": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "CONTAINS": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRSTARTS": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRENDS": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRBEFORE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRAFTER": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "YEAR": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "MONTH": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DAY": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "HOURS": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "MINUTES": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SECONDS": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "TIMEZONE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "TZ": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "NOW": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "UUID": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRUUID": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "MD5": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SHA1": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SHA256": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SHA384": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SHA512": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "COALESCE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "IF": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRLANG": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRDT": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SAMETERM": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "ISURI": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "ISIRI": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "ISBLANK": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "ISLITERAL": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "ISNUMERIC": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "TRUE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "FALSE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "COUNT": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SUM": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "MIN": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "MAX": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "AVG": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SAMPLE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "GROUP_CONCAT": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "SUBSTR": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "REPLACE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "REGEX": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "EXISTS": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "NOT": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "IRI_REF": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRING_LITERAL1": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRING_LITERAL2": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRING_LITERAL_LONG1": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "STRING_LITERAL_LONG2": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "INTEGER": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DECIMAL": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DOUBLE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "INTEGER_POSITIVE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DECIMAL_POSITIVE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DOUBLE_POSITIVE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "INTEGER_NEGATIVE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DECIMAL_NEGATIVE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "DOUBLE_NEGATIVE": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "PNAME_LN": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"], 
     "PNAME_NS": ["multiplicativeExpression","*or([[+,multiplicativeExpression],or([[-,multiplicativeExpression],[or([numericLiteralPositive,numericLiteralNegative]),*or([[*,unaryExpression],[/,unaryExpression]])]])])"]}, 
  "aggregate" : {
  ...
  "describeQuery" : {
     "DESCRIBE": ["DESCRIBE","or([+varOrIri,*])","*datasetClause","?whereClause","solutionModifier"]}, 
  "drop" : {
  ...
  "modify" : {
     "DELETE": ["?[WITH,iri]","or([[deleteClause,?insertClause],insertClause])","*usingClause","WHERE","groupGraphPattern"], 
     "INSERT": ["?[WITH,iri]","or([[deleteClause,?insertClause],insertClause])","*usingClause","WHERE","groupGraphPattern"], 
     "WITH": ["?[WITH,iri]","or([[deleteClause,?insertClause],insertClause])","*usingClause","WHERE","groupGraphPattern"]}, 
  "move" : {
  ...
  "propertyListPathNotEmpty" : {
     ...
     "!": ["or([verbPath,verbSimple])","objectListPath","*[;,?[or([verbPath,verbSimple]),objectList]]"], 
     "(": ["or([verbPath,verbSimple])","objectListPath","*[;,?[or([verbPath,verbSimple]),objectList]]"], 
     "DISTINCT": ["or([verbPath,verbSimple])","objectListPath","*[;,?[or([verbPath,verbSimple]),objectList]]"], 
  ...
  "update1" : {
     "LOAD": ["load","clear","drop","add","move","copy","create","insertData","deleteData","deleteWhere","modify"]}, 
  "usingClause" : {
